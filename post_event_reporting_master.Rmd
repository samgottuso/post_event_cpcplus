...
survey_percents<-ggplot(melted_comparison[55:60,],aes(x=variable,y=as.numeric(value),fill=Event_name))+geom_bar(stat='identity')+coord_polar(theta='x')
survey_percents_event1

source('multiplot.R')
multiplot(role_barplot,survey_percents)
