...
PIA_4_first_import<-read_excel(path='C:/Users/583185/Desktop/data_science/post_event_reporting/PIA4_BHI_CM_analysis.xlsx',sheet = 2)
...
#PIA6
PIA_6_first_import<-read_excel(path='C:/Users/583185/Desktop/data_science/post_event_reporting/PIA6_Data_Patients_analysis.xlsx',sheet = 1)

PIA_6_survey_first_import<-read_excel(path='C:/Users/583185/Desktop/data_science/post_event_reporting/PIA6_Data_Patients_Survey.xlsx',sheet = 1)

#PIA7

PIA_7_first_import<-read_excel(path='C:/Users/583185/Desktop/data_science/post_event_reporting/PIA7_Data_Specialty_analysis.xlsx',sheet = 1)

PIA_7_survey_first_import<-read_excel(path='C:/Users/583185/Desktop/data_science/post_event_reporting/PIA7_Data_Specialty_Survey.xlsx',sheet = 1)
...
map_cleaner<-function(type,imported_data){
  if(type=="adobe"){
    ...
    cleaned_data<-cleaned_data[cleaned_data$Type=="Primary Care Practice",]
  }
...
event_map_data<-map_cleaner("adobe",PIA_7_first_import)
