...
grid.draw(grobTree(rectGrob(gp=gpar(fill="#328CC1")),arrangeGrob(attendance_gauge,survey_gauge,ncol = 2)))
...
This map shows us a representation of where practices were attending from.

```{r, echo=FALSE, message=FALSE, warning=FALSE}
event_map_data<-map_cleaner("adobe",PIA_9_first_import)
...
colnames(state_shapes_table)<-"State Count"
kable(state_shapes_table,caption="Attendance by State")
